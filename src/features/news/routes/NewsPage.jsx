...
function Header({children}) {
	return <div style={{ height: '80px', display: 'flex', alignItems: 'center', margin: '0 180px', borderBottom: '1px solid rgba(0, 0, 0, 0.3)' }} >{children}</div>
}
...
export default function NewsPage() {
	...
	return <Container><Header><h1>Faker News</h1></Header>
